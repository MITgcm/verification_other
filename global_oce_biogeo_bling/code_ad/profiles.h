C $Header: /u/gcmpack/MITgcm_contrib/verification_other/global_oce_biogeo_bling/code_ad/Attic/profiles.h,v 1.1 2014/06/05 21:41:21 mmazloff Exp $
C $Name:  $
...
CMM(
      PARAMETER ( NFILESPROFMAX=12 )
CMM)
      INTEGER NVARMAX
CMM(
      PARAMETER ( NVARMAX=13 )
CMM)
      INTEGER NLEVELMAX
